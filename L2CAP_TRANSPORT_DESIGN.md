...
- **Default PSM**: `0x0080` (128 decimal)
...
1. **Peripheral (Zephyr)**
   ...
   - Register L2CAP server on PSM 0x0080
...
2. **Central (iOS)**
   ...
   - Open L2CAP channel to PSM 0x0080
